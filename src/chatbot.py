...
class CSVChatbot:
    ...
    def ask(self, question):
        ...
        while retries < max_retries:
            ...
            validation = validate_query(rephrased_question, query, schema, execution_error="None")
        ...
        # fallback correction if execution failed
        if error:

            print("\nExecution Error Detected:", error)
            ...
            if "Corrected_Query:" in validation:
                ...
                corrected_query = validation.split("Corrected_Query:")[-1].strip()
                ...
                result, error = execute_query(corrected_query, self.df)
